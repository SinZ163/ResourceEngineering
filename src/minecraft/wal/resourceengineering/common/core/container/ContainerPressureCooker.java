...
public class ContainerPressureCooker extends Container {
	...
	protected PressureCookerTileEntity tile_entity;
	...
	public ContainerPressureCooker(PressureCookerTileEntity tile_entity,InventoryPlayer player_inventory)
	{
		this.tile_entity = tile_entity;
		// The more stacks you have the more slots you need
		// This has 1 param
		// @param slot, this is the slot declaration, and you can declare a new
		addSlotToContainer(new PressureCookerInputSlot(tile_entity, 0, 50, 20));
		addSlotToContainer(new PressureCookerFuelSlot(tile_entity, 1, 50, 53));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotnumber)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			else if (RecipesPressureCooker.smelting().getSmeltingResult(itemstack1.getItem().itemID) != null)
			{
			...
			else if (PressureCookerTileEntity.isItemFuel(itemstack1))
			{
